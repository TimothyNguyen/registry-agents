...
1. `~/.copilot/skills/<skill-name>/` or `~/.agents/skills/<skill-name>/` (user installs)
2. `.github/skills/<skill-name>/` or `.agents/skills/<skill-name>/` in the project
...
1. `~/.codex/skills/<skill-name>/` (user install)
2. `.codex/skills/<skill-name>/` (project install)
